...
const states = {
    ...
    power_consumed:   {name: 'Power consumed',        role: 'value.consumption', write: false, read: true, type: 'number', unit: 'Wh'},     // That's right, not kWh
    ...
    heartbeat:        {name: 'HeartBeat',             role: 'indicator.heartbeat',    write: false, read: true, type: 'number'}
};
...
const devices = {
    ...
    // Added new states for acpartner3
    acpartner3:             {type: 'acpartner.v3',    fullName: 'Xiaomi Aqara AC partner Gateway', ClassName: Gateway, states: {
            ...
            temp_cfg:       {name: 'Air conditioning temperature',      role: 'level.temperature',          write: true, read: true,  type: 'string'},
    ...
    weather:          {type: 'weather.v1',         fullName: 'Xiaomi Temperature/Humidity/Pressure', ClassName: THSensor, states: {
            ...
            temperature:  states.temperature,
            humidity:     states.humidity,
            pressure:     {name: 'Pressure',        role: 'value.pressure',    write: false, read: true, type: 'number', unit: 'hPa', min: 100, max: 1100},
            doublePress:  states.doublePress
        }
    },
    // To support protocol v 2.0.x (issue #93)
    ...
    plug:             {type: 'plug',               fullName: 'Xiaomi Smart Plug', ClassName: Plug, states: {
            // voltage:          states.voltage,    There is no battery in this device
            // percent:          states.percent,    There is no battery in this device
    ...
    // for protocol v1
    ctrl_neutral2_b2nacn02p1:    {type: 'switch_b2nacn02',      fullName: 'Aqara D1 2 gang smart wall switch (with neutral wire)', ClassName: WallWiredSwitch, states: {
            channel_0:      states.wall_switch0,
            channel_1:      states.wall_switch1,
            heartbeat:        states.heartbeat
        }
    ...
    // for protocol v2
    ctrl_neutral2_b2nacn02p2:    {type: 'switch.b2nacn02',      fullName: 'Aqara D1 2 gang smart wall switch (with neutral wire)', ClassName: WallWiredSwitch, states: {
            channel_0:        states.wall_switch0,
            channel_1:        states.wall_switch1,
            heartbeat:        states.heartbeat
        }
