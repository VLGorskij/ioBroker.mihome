...
function Plug (sid, ip, hub, model) {
    ...
    this.state          = null;
    this.inuse          = null;
    this.lastReply      = undefined;     // время последнего ответа 
...
Plug.prototype.getData = function (data, isHeartbeat) {
    let newData = false;
    let obj = {};
    
    // const ts = Date.now();          // текущее время
